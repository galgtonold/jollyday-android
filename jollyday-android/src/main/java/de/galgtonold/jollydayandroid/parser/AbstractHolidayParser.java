...
public abstract class AbstractHolidayParser implements HolidayParser {
	 ...
	 *
	 * @param fm
	 *            a {@link de.galgtonold.jollydayandroid.config.MoveableHoliday} object.
	 * @param fixed
	 ...
	 *            a {@link org.joda.time.LocalDate} object.
	 * @param mc
	 *            a {@link de.galgtonold.jollydayandroid.config.MovingCondition} object.
	 * @return a boolean.
	 */
	 ...
	 *            a int.
	 * @param ct
	 *            a {@link de.galgtonold.jollydayandroid.config.ChronologyType} object.
